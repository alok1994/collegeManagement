...
def student_list_details(request):
    ...
    return render(request, 'character_certificate/student_details_char_cert.html', {'class_students': class_students, 'class_choices': class_choices, 'selected_class': selected_class,})
...
def view_character_certificate(request, student_id):
    ...
    activate('hi')
    return render(request, 'character_certificate/view_character_certificate.html', {
        'admission_form': admission_form,
